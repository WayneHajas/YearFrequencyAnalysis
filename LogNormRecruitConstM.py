...
* Annual recruitment is lognormally distributed. No auto-correlation
...
from LogNormRecruit import Recruit
from Multinomial import SurveySampling

class LogNormRecruitConstM(Mortality,Recruit,SurveySampling):
...
if __name__ == "__main__":
    ...
    test=LogNormRecruitConstM(yearbornfrequency)